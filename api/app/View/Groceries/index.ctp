<div class="groceries index">
	<h2><?php echo __('Groceries'); ?></h2>
	...
	<tr>
		<td><?php echo h($grocery['Grocery']['id']); ?>&nbsp;</td>
		<td><?php echo h($grocery['Grocery']['name']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $grocery['Grocery']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $grocery['Grocery']['id']), null, __('Are you sure you want to delete # %s?', $grocery['Grocery']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
